...
| [20260831T0000Z-eugr-remaining-cells](20260831T0000Z-eugr-remaining-cells/) | 2026-08-31 | 3 / 3 | `PRESENT-PASS` | The three remaining engine-A/B cells on the eugr serving config (nst=5, mnbt=8192, persistent caches, port 8100): 131K-context decode 90.5 vs anemll 83.5 (+8%, TTFT 53.7s vs 138.1s); prompt-effect pair at ours-bench.py conditions on the EXACT original prompts (dense-prose recovered from git commit b078eb4) 91.0 / 49.2 vs 81.8 / 49.4, ratio 1.85x vs 1.65x; deep concurrency 4x200K TTFT 224s vs ~870s, 1.26 tok/s, still unusable as a workload. Completes docs/ENGINE-AB-3NODE.md. |
