...
|---|---|---|
| 3-rank collective is **3.25 GB/s** where published rings report 18–21 | [#11](https://github.com/colonel-otto/3spark-dsv4/issues/11) | **Bounds everything else.** Transport verified `NET/IB/2`, all pairs healthy |
