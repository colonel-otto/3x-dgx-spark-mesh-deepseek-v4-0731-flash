...
| [`BANDWIDTH-COMPARISON.md`](BANDWIDTH-COMPARISON.md) | ✅ | **The ~3.2x gap vs published 3-Spark rings, verified against primary sources.** The live lead is HCA *pairing*, not count. Read before chasing it. |
